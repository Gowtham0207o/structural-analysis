<div class="container  col-md-5 col-lg-6 col-xlg-10 custom_footer border-top pt-4">
    <footer class="pt-4">
      <div class="row">
        <div class="col-4 offset-0.5">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 text-muted">Truss Analysis</a>
            </li>
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 text-muted">Beam Analysis</a>
            </li>
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 text-muted">Support Reaction</a>
            </li>
            <li class="nav-item mb-2">
      ...
      <div class="d-flex justify-content-between py-4 my-4 border-top">
        ...
        <p>Site created by <a href="https://gowtham.selfmade.one">Gowtham</a></p>
